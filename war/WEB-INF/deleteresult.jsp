			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">delete results</h4>
					</div>

					<!-- *******************new folder creation action *******************************-->
					<form name="createdrive" action="/" method="post">
					<p>${errorMessage}</p>
						<div class="modal-body">
							<table>
                            <c:forEach items="${driveName}" var="name">
                            <tr>
                            <td>${name.driveName} <p>drive is deleted</p></td>
                            </tr>
                            </c:forEach>
                            </table>
                            ...
                            <tr>
                            <td>${name.folderName} <p>folder is deleted</p></td>
                            </tr>
                            </c:forEach>
                            </table>
                            <table>
                            ...
                            <tr>
                            <td>${name1.fileName}<p>file is deleted</p></td>
                            </tr>
                            </c:forEach>
                            </table>
